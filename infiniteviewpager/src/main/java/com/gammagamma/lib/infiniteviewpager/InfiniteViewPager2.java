...
public class InfiniteViewPager2 extends ViewPager {
    
    private static final String TAG = InfiniteViewPager2.class.getSimpleName();
    ...
    public InfiniteViewPager2( Context context, AttributeSet attrs ) {
        super( context, attrs );
        weakContext = new WeakReference<>( context );
        pageChangeListener = new PageChangeListener( this );
        addOnPageChangeListener( pageChangeListener );
    ...
    private static class PageChangeListener implements OnPageChangeListener {
        ...
        private final InfiniteViewPager2 viewPager;
    
        public PageChangeListener( final InfiniteViewPager2 viewPager ) {
